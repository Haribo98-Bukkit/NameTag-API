package com.haribo98.nametag.versions.V1_4;
...
public class PlayerTag_V1_4 {
	
	public Player player;
	public Main plugin;
	
	public PlayerTag_V1_4(Player player) {
		this.player = player;
	}
	
	public PlayerTag_V1_4(Player player, Main plugin) {
		this.player = player;
		this.plugin = plugin;
	}
